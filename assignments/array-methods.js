...
// fullName = runners.map(function(element) {
//     return element.first_name + " " + element.last_name;
// });

// fullName = runners.map(element => element.first_name + " " + element.last_name);
...
ticketPriceTotal = runners.map(element => element.donation).reduce((accumulator, currentValue) => accumulator + currentValue);
